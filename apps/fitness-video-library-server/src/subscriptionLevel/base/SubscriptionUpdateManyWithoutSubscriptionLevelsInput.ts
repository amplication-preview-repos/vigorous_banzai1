...
@InputType()
class SubscriptionUpdateManyWithoutSubscriptionLevelsInput {
...
export { SubscriptionUpdateManyWithoutSubscriptionLevelsInput as SubscriptionUpdateManyWithoutSubscriptionLevelsInput };
