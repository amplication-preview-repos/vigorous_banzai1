...
export class SubscriptionResolverBase {
  ...
  async createSubscription(
    ...
    return await this.service.createSubscription({
      ...
      data: {
        ...
        subscriptionLevel: args.data.subscriptionLevel
          ? {
              connect: args.data.subscriptionLevel,
            }
          : undefined,
  ...
  @graphql.ResolveField(() => SubscriptionLevel, {
    nullable: true,
  ...
  async getSubscriptionLevel(
    ...
    const result = await this.service.getSubscriptionLevel(parent.id);
